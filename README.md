# Tic-Tac-Toe-game
OBJECTIVE:
This project for self learning aims to develop a Tic Tac Toe game using javascript. It mainly consists of developing and implementing a computer program that plays Tic Tac Toe against another player.
